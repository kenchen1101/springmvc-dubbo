...
(
   ...
   is_del               number(10)                        not null default 0,
   constraint pk_t_auth_permission primary key clustered (id)
);
...
comment on primary key on t_auth_permission is '菜单许可表主键';
...
(
   ...
   update_time          timestamp                      null,
   is_del               number(10)                        not null default 0,
   constraint pk_t_auth_role primary key clustered (id)
);
...
comment on primary key on t_auth_role is '后台角色表主键';
...
(
   ...
   update_time          timestamp                      null,
   is_del               number(10)                        not null default 0,
   constraint pk_t_auth_role_permission primary key clustered (id)
);
...
comment on primary key on t_auth_role_permission is '用户角色关系表主键';
...
(
   ...
   update_time          timestamp                      null,
   is_del               number(10)                        not null default 0,
   constraint pk_t_auth_user primary key clustered (id)
);
...
comment on primary key on t_auth_user is '后台用户表主键';
...
(
   ...
   update_time          timestamp                      null,
   is_del               number(10)                        not null default 0,
   constraint pk_t_auth_user_role primary key clustered (id)
);
...
comment on primary key on t_auth_user_role is '用户角色关系表主键';