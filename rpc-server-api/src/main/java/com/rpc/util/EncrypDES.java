...
public class EncrypDES {
     ...
     * @throws BadPaddingException
     */
    public byte[] decryptDES(String buff) throws InvalidKeyException, IllegalBlockSizeException, BadPaddingException {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String msg = "123abc";
        String encontent = de1.encryptDES(msg);
        byte[] decontent = de1.decryptDES(encontent);
